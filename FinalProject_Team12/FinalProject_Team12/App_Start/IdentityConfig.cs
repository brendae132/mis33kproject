...
namespace FinalProject_Team12
{
    ...
    public class AppUserManager : UserManager<AppUser>
    {
        ...
        public static AppUserManager Create(IdentityFactoryOptions<AppUserManager> options, IOwinContext context) 
        {
            ...
            var customer = new AppUserManager (new UserStore<AppUser>(context.Get<AppDbContext>()));
            ...
            customer.UserValidator = new UserValidator<AppUser>(customer)
            {
                AllowOnlyAlphanumericUserNames = false,
                RequireUniqueEmail = true
            };
            ...
            customer.PasswordValidator = new PasswordValidator
            {
                RequiredLength = 6,
                RequireNonLetterOrDigit = false,
                RequireDigit = true,
